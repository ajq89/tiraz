        ...
        <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-xl space-y-6 text-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-500 leading-relaxed font-medium">
              الرجاء إدخال رمز المرور للوصول إلى لوحة التحكم وإجراء التعديلات على الأسعار والمخزون والكتالوج ورسوم التوصيل.
            </p>
          </div>
          ...
          <div className="pt-4 border-t border-slate-100">
            <div className="bg-amber-50 border border-amber-200/65 rounded-xl p-3 text-right">
              ...
              <p className="text-[10px] text-amber-700 font-medium leading-relaxed mt-0.5">
                يمكنك استخدام الرمز الافتراضي <strong className="font-extrabold text-amber-900">1234</strong> لفتح لوحة التحكم فوراً والتحقق من التعديلات.
              </p>
            </div>
          </div>
        </div>
